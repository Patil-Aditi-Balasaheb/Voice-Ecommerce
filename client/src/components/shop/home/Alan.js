  ...
  useEffect(() => {
    ...
    function sendCategory() {
      ...
      alanBtnInstance.callProjectApi(
        ...
        {
          categories:
            "Electronics, Fashion, Home and Garden, Sports, Health and Beauty, Collectibles and Art Products",
        },
      ...
      onCommand: (commandData) => {
        if (commandData.command === "showCart") {
          ...
          const foundProduct = homeData.products.find((product) =>
            product.pName.toLowerCase().search(commandData.title.toLowerCase())
          );
